		...
		<div class="">
			...
			<div class="row">
				<div id="principal" class="container-fluid">
					<div id="primeiroh1" style="background-image:url('images/fundoblue.jpg');">
						<div id="lojaTitle">
			...
			<div class="col-md-6 col-sm-4 col-lg-6 especializacao">
					<CENTER><h1 class="darius">Especializações</H1></center>
				<div class="masteryi">
					<center><img src="images/especializacoes/arduino.png" class="img-loja-fisica img-responsive" TITLE="Arduino" alt="Arduino">
					<img src="images/especializacoes/sistema.png" class="img-loja-fisica img-responsive" TITLE="Sistemas de Informação">
					<img src="images/especializacoes/etec.png" style="height:250px;width:250px;"class="img-loja-fisica img-responsive" TITLE="Etec Dr Adail Nunes da Silva">
					<img src="images/especializacoes/photography.png" class="img-loja-fisica img-responsive" TITLE="Fotografia">
					<img src="images/especializacoes/compumed.png" class="img-loja-fisica img-responsive" TITLE="Empresa Compumed">
			...
			<div class="col-md-6 col-sm-6 col-lg-6">
				<div id="parteloja">
					<section id="explicatudo">
						<form method="POST" action="cadloja.php">
							<span class="responsividadeetop"><!--h1 class="nossaloja"--><textarea name="tituloNossaLoja"><?=$rowTitulo['0'];?></textarea><!--/h1--></span><br>
							<article id="empresa">
								<textarea name="txtNossaLoja"style="height:400px; width:100%;"><?=$rowTexto['0'];?></textarea>
							</article>
								<span class="responsividadeetop"><textarea style="width:390px;" name="txtGoogleMaps">
								<?=$rowMaps['0'];?>
								</textarea></span>
								<br/>
							<button type="submit" class="btn btn-info responsividadeetop">Alterar Dados</button>
						</form>
					</section>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6">
                    <center>
                        ...
                        <div id="listaMarcas">
							...
							<br/>
							<input type="text" name="inputFace" value="<?=$rowFace['0'];?>">
							
							<input type="text" name="inputTwitter" value="<?=$rowTwi['0'];?>">
							
							<input type="text" name="inputGmail" value="<?=$rowGoogle['0'];?>">
							<br/><br/>
