...
<html lang="pt-br">
    ...
    <body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'; font-size:100%;">
		...
		<!--button onclick="topFunction()" id="myBtn" title="Go to top"><i class="icon-chevron-up icon-white"></i></button-->
		
        <div class=" container-fluid">
            <header id="cabecalho">

                <nav class= "navbar navbar-fixed-top navbar-inverse" >
                    <div class="navbar-inner responsividadenaimagem" style="background-image:url('aps/images/fundomenu.jpg');">
        ...
        <div id="jssor_1" class="carrosselresponsive"style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;">
            ...
            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;">
                <div data-p="225.00">
                    <img data-u="image" src="aps/images/Carrossel/<?=$rowslide1['0'];?>" />
                ...
                <div data-p="225.00">
                    <img data-u="image" src="aps/images/Carrossel/<?=$rowslide2['0'];?>" />
                </div>
                <div data-p="225.00">
                    <img data-u="image" src="aps/images/Carrossel/<?=$rowslide3['0'];?>" />
                </div>
            </div>
            <!-- Bullet Navigator -->
        ...
        <div class="container">
			...
			echo "
				...
				<li>
					<div id=\"homequadro-".$cont."\" class=\"\">

						<div style=\"flex: 1 1 400px;\" class=\"col-sm-12 col-xs-12 col-md-6 col-lg-6 col-xl-4\">
						
								<center><h2>$row[0]</h2></center>
								
								<img id=\"imagempost\"style=\"width:588px; height:411px;\" src=\"aps/images/Blog/$row[1]\">
    ...
    <div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
        <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
            ...
            <div id="cd-login"> <!-- log in form -->
                <form class="cd-form" method="POST" action="http://olianijr.com/aula">
                    <p class="fieldset">
            ...
            <div id="cd-reset-password"> <!-- reset password form -->
                ...
                <form class="cd-form">
                    ...
                    <p class="fieldset">
                        <input class="full-width has-paddzing" type="submit" value="Reset password">
                    </p>
                </form>
